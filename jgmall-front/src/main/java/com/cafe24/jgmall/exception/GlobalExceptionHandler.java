...
import com.cafe24.jgmall.dto.JSONResultSender;
...
//		System.out.println(errors.toString());
		...
		if(accept.matches(".*application.json.*")) {
			...
			JSONResultSender jsonResultSender = JSONResultSender.fail(errors.toString());
			String result = new ObjectMapper().writeValueAsString(jsonResultSender);
